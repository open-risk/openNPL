...
Aligned with the approach for the EBA NPL classes, SFLP data models are split in separate files following the TABLE_NAME.py convention in the sflp_portfolio directory.
