...
Each data model is implemented in a separate file TABLE_NAME.py in the npl_portfolio directory. In addition there is a **Portfolio Model** and a **Portfolio Snapshot Model** implemented in the (models.py) file. These models extend the EBA recommendation to improve the usability of the openNPL platform.
